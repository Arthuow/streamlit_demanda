...
#################################### DATA_HORA_ESPECIFICA_COINCIDENTE ##################################################
data_hora_coincidente = '2023-6-18 10:00:00'
data_hora_coincidente = pd.to_datetime(data_hora_coincidente)
df_base = df_base_original.query('DATA_HORA == @data_hora_coincidente')
df_base.info
print(df_base)
...
print("Colunas não numéricas:", non_numeric_columns)
#df_dados_com_meses_anos_Q['Carregamento'] = (df_dados_com_meses_anos_Q['Pot. Máxima'] / df_dados_com_meses_anos_Q['Potencia Instalada'].where(df_dados_com_meses_anos_Q['Potencia Instalada'] > 0, other=1))*100
#df_dados_com_meses_anos_Q['Carregamento'] =df_dados_com_meses_anos_Q['Carregamento'].round(2)
...
dir = r"C:\Users\Engeselt\Documents\GitHub\ASPO_2\Demanda_Mínima_Coincidente.xlsx"
